...
public class GlintModify extends Module {
    ...
    public static Color getColor(long offset, float fade) {
        if (!OyVey.moduleManager.getModuleByClass(GlintModify.class).rainbow.getValue()) {
            return new Color(OyVey.moduleManager.getModuleByClass(GlintModify.class).red.getValue(), OyVey.moduleManager.getModuleByClass(GlintModify.class).green.getValue(), OyVey.moduleManager.getModuleByClass(GlintModify.class).blue.getValue());
        }
